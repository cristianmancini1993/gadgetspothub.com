#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate ForgeX portable welder landings for CEE geos (offers #166–#171)."""
...
# ForgeX product copy per language key (si/ro/pl/hu/cz/sk)
COPY = {
    "si": {
        "title": "ForgeX™ — Prenosni varilni aparat 8 v 1 MIG TIG elektroda | -60%",
        "description": "ForgeX™: prenosni varilni aparat 8 v 1 (MIG, TIG, elektroda, rezanje) do 200A in 5 mm. Kompletni komplet vključen, plačilo po povzetju v Sloveniji.",
        ...
        "h1": "Ne kupujte 8 različnih aparatov.<br>Dovolj je eden: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX prenosni varilni aparat 8 v 1",
        "cta": "DA, ŽELIM ForgeX™ →",
        ...
        "live": "<strong>{n} oseb</strong> trenutno gleda ForgeX",
        "live0": "<strong>41 oseb</strong> trenutno gleda ForgeX",
        ...
        "alt_d1": "ForgeX 8 funkcij v enem aparatu",
        "ey2": "02 — Profesionalni rezultati takoj",
        "h3_2": "Čisti zvari in samodejna regulacija toka",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "Zaradi vgrajenih sistemov Hot Start, Anti-Stick in Arc Force ostane lok stabilen tudi, če še niste držali elektrode. Izberete material in debelino: <strong>ForgeX™ sam nastavi napetost in amperažo.</strong>",
        "i2": "Konec zažganih zvarov in lukenj v pločevini — čisti rezultati že od prvega uporabe.",
        "alt_d2": "ForgeX čisti zvari in samodejna regulacija",
        ...
        "alt_d3": "ForgeX prenosni varilec za garažo in gradbišče",
        "cmp_label": "Zakaj se res splača",
        "cmp_h2": "Ločeni varilci vs ForgeX™",
        ...
        "kit_h2": "📦 Kompletni komplet ForgeX™ 8 v 1",
        "alt_kit": "Kompletni komplet ForgeX prenosni varilec",
        "li1": "<strong>1× Varilec ForgeX™</strong> 8 v 1 (MIG · TIG · elektroda · rezanje)",
    ...
    "ro": {
        "title": "ForgeX™ — Aparat de sudură portabil 8 în 1 MIG TIG electrod | -60%",
        "description": "ForgeX™: aparat de sudură portabil 8 în 1 (MIG, TIG, electrod, tăiere) până la 200A și 5 mm. Kit complet inclus, plata ramburs în România.",
        ...
        "h1": "Nu cumpăra 8 aparate diferite.<br>Îți trebuie doar unul: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX aparat de sudură portabil 8 în 1",
        "cta": "DA, VREAU ForgeX™ →",
        ...
        "live": "<strong>{n} persoane</strong> privesc ForgeX acum",
        "live0": "<strong>41 persoane</strong> privesc ForgeX acum",
        ...
        "alt_d1": "ForgeX 8 funcții într-un singur aparat",
        "ey2": "02 — Rezultate profesionale din prima",
        "h3_2": "Suduri curate și reglare automată a curentului",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "Datorită sistemelor Hot Start, Anti-Stick și Arc Force, arcul rămâne stabil chiar dacă nu ai mai ținut un electrod. Alegi materialul și grosimea: <strong>ForgeX™ setează singur tensiunea și amperajul.</strong>",
        "i2": "Gata cu sudurile arse și găurile în tablă — rezultate curate de la prima utilizare.",
        "alt_d2": "ForgeX suduri curate și reglare automată",
        ...
        "alt_d3": "ForgeX portabil pentru garaj și șantier",
        "cmp_label": "De ce merită cu adevărat",
        "cmp_h2": "Aparate separate vs ForgeX™",
        ...
        "kit_h2": "📦 Kitul complet ForgeX™ 8 în 1",
        "alt_kit": "Kit complet ForgeX aparat de sudură portabil",
        "li1": "<strong>1× Aparat ForgeX™</strong> 8 în 1 (MIG · TIG · electrod · tăiere)",
    ...
    "pl": {
        "title": "ForgeX™ — Przenośna spawarka 8 w 1 MIG TIG elektroda | -60%",
        "description": "ForgeX™: przenośna spawarka 8 w 1 (MIG, TIG, elektroda, cięcie) do 200A i 5 mm. Pełny zestaw w zestawie, płatność przy odbiorze w Polsce.",
        ...
        "h1": "Nie kupuj 8 różnych urządzeń.<br>Wystarczy jedno: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX przenośna spawarka 8 w 1",
        "cta": "TAK, CHCĘ ForgeX™ →",
        ...
        "live": "<strong>{n} osób</strong> ogląda teraz ForgeX",
        "live0": "<strong>41 osób</strong> ogląda teraz ForgeX",
        ...
        "alt_d1": "ForgeX 8 funkcji w jednym urządzeniu",
        "ey2": "02 — Profesjonalne efekty od razu",
        "h3_2": "Czyste spoiny i automatyczna regulacja prądu",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "Dzięki systemom Hot Start, Anti-Stick i Arc Force łuk pozostaje stabilny nawet jeśli nigdy nie trzymałeś elektrody. Wybierasz materiał i grubość: <strong>ForgeX™ sam ustawia napięcie i amperaż.</strong>",
        "i2": "Koniec ze spalonymi spoinami i dziurami w blasze — czyste efekty od pierwszego użycia.",
        "alt_d2": "ForgeX czyste spoiny i automatyczna regulacja",
        ...
        "alt_d3": "ForgeX przenośna spawarka do garażu i budowy",
        "cmp_label": "Dlaczego naprawdę warto",
        "cmp_h2": "Osobne spawarki vs ForgeX™",
        ...
        "kit_h2": "📦 Kompletny zestaw ForgeX™ 8 w 1",
        "alt_kit": "Kompletny zestaw ForgeX przenośna spawarka",
        "li1": "<strong>1× Spawarka ForgeX™</strong> 8 w 1 (MIG · TIG · elektroda · cięcie)",
    ...
    "hu": {
        "title": "ForgeX™ — Hordozható hegesztőgép 8 az 1-ben MIG TIG elektróda | -60%",
        "description": "ForgeX™: hordozható hegesztőgép 8 az 1-ben (MIG, TIG, elektróda, vágás) 200A-ig és 5 mm-ig. Teljes készlet benne, utánvét Magyarországon.",
        ...
        "h1": "Ne vegyen 8 különböző gépet.<br>Elég egy: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX hordozható hegesztőgép 8 az 1-ben",
        "cta": "IGEN, KÉREM a ForgeX™-t →",
        ...
        "live": "<strong>{n} ember</strong> nézi most a ForgeXt",
        "live0": "<strong>41 ember</strong> nézi most a ForgeXt",
        ...
        "alt_d1": "ForgeX 8 funkció egyetlen gépben",
        "ey2": "02 — Professzionális eredmény azonnal",
        "h3_2": "Tiszta varratok és automatikus áramszabályozás",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "A beépített Hot Start, Anti-Stick és Arc Force rendszereknek köszönhetően az ív stabil marad akkor is, ha még soha nem tartott elektródát. Válassza ki az anyagot és a vastagságot: <strong>a ForgeX™ magától beállítja a feszültséget és az ampert.</strong>",
        "i2": "Nincs többé megégett varrat és lyuk a lemezen — tiszta eredmény már az első használattól.",
        "alt_d2": "ForgeX tiszta varratok és automatikus szabályozás",
        ...
        "alt_d3": "ForgeX hordozható hegesztő garázsba és telephelyre",
        "cmp_label": "Miért éri meg igazán",
        "cmp_h2": "Külön gépek vs ForgeX™",
        "th_sep": "3 külön gép",
        "r1a": "Költség",
        "r1b": "≈ {sep}",
        "r1c": "{now} egyszer",
        ...
        "kit_h2": "📦 A teljes ForgeX™ 8 az 1-ben készlet",
        "alt_kit": "Teljes ForgeX hordozható hegesztő készlet",
        "li1": "<strong>1× ForgeX™ hegesztő</strong> 8 az 1-ben (MIG · TIG · elektróda · vágás)",
    ...
    "cz": {
        "title": "ForgeX™ — Přenosná svářečka 8 v 1 MIG TIG elektroda | -60%",
        "description": "ForgeX™: přenosná svářečka 8 v 1 (MIG, TIG, elektroda, řezání) až 200A a 5 mm. Kompletní sada v balení, platba na dobírku v Česku.",
        ...
        "h1": "Nekupujte 8 různých přístrojů.<br>Stačí jeden: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX přenosná svářečka 8 v 1",
        "cta": "ANO, CHCI ForgeX™ →",
        ...
        "live": "<strong>{n} lidí</strong> právě prohlíží ForgeX",
        "live0": "<strong>41 lidí</strong> právě prohlíží ForgeX",
        ...
        "alt_d1": "ForgeX 8 funkcí v jednom přístroji",
        "ey2": "02 — Profesionální výsledky hned",
        "h3_2": "Čisté svary a automatická regulace proudu",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "Díky systémům Hot Start, Anti-Stick a Arc Force zůstává oblouk stabilní, i když jste nikdy nedrželi elektrodu. Zvolíte materiál a tloušťku: <strong>ForgeX™ sám nastaví napětí a ampéry.</strong>",
        "i2": "Konec spálených svarů a děr v plechu — čisté výsledky od prvního použití.",
        "alt_d2": "ForgeX čisté svary a automatická regulace",
        ...
        "alt_d3": "ForgeX přenosná svářečka do garáže a na stavbu",
        "cmp_label": "Proč se to opravdu vyplatí",
        "cmp_h2": "Samostatné svářečky vs ForgeX™",
        ...
        "kit_h2": "📦 Kompletní sada ForgeX™ 8 v 1",
        "alt_kit": "Kompletní sada ForgeX přenosná svářečka",
        "li1": "<strong>1× Svářečka ForgeX™</strong> 8 v 1 (MIG · TIG · elektroda · řezání)",
    ...
    "sk": {
        "title": "ForgeX™ — Prenosná zváračka 8 v 1 MIG TIG elektróda | -60%",
        "description": "ForgeX™: prenosná zváračka 8 v 1 (MIG, TIG, elektróda, rezanie) až 200A a 5 mm. Kompletná sada v balení, platba na dobierku na Slovensku.",
        ...
        "h1": "Nekupujte 8 rôznych prístrojov.<br>Stačí jeden: <span class=\"hl\">ForgeX™</span>",
        ...
        "alt_hero": "ForgeX prenosná zváračka 8 v 1",
        "cta": "ÁNO, CHCEM ForgeX™ →",
        ...
        "live": "<strong>{n} ľudí</strong> práve pozerá ForgeX",
        "live0": "<strong>41 ľudí</strong> práve pozerá ForgeX",
        ...
        "alt_d1": "ForgeX 8 funkcií v jednom prístroji",
        "ey2": "02 — Profesionálne výsledky hneď",
        "h3_2": "Čisté zvary a automatická regulácia prúdu",
        "tag2a": "Hot Start",
        "tag2b": "Anti-Stick",
        "tag2c": "Arc Force",
        "p2": "Vďaka systémom Hot Start, Anti-Stick a Arc Force zostáva oblúk stabilný, aj keď ste nikdy nedržali elektródu. Zvolíte materiál a hrúbku: <strong>ForgeX™ sám nastaví napätie a ampére.</strong>",
        "i2": "Koniec spálených zvarov a dier v plechu — čisté výsledky od prvého použitia.",
        "alt_d2": "ForgeX čisté zvary a automatická regulácia",
        ...
        "alt_d3": "ForgeX prenosná zváračka do garáže a na stavbu",
        "cmp_label": "Prečo sa to naozaj oplatí",
        "cmp_h2": "Samostatné zváračky vs ForgeX™",
        "th_sep": "3 samostatné stroje",
        "r1a": "Cena",
        "r1b": "≈ {sep}",
        "r1c": "{now} raz",
        ...
        "kit_h2": "📦 Kompletná sada ForgeX™ 8 v 1",
        "alt_kit": "Kompletná sada ForgeX prenosná zváračka",
        "li1": "<strong>1× Zváračka ForgeX™</strong> 8 v 1 (MIG · TIG · elektróda · rezanie)",
...
<link rel="canonical" href="https://gadgetspothub.com/{geo}/{slug}/landing.html">
</head>
<body>
<p><a href="/{geo}/{slug}/landing.html">ForgeX™</a></p>
</body>
</html>
"""
...
<section class="compare wrap">
  ...
  <h2>{cmp_h2}</h2>
  <table>
    <tr><th></th><th>{th_sep}</th><th class="highlight">ForgeX™</th></tr>
...
def render_thank_you(offer: str, cfg: dict, copy: dict, shared: dict, it_ty: str) -> str:
    ...
    ty_title = shared["ty_title"].replace("GlacierAir™", "ForgeX™")
    html = re.sub(r"<title>.*?</title>", f"<title>{ty_title}</title>", html, count=1)
    ty_desc = shared.get("ty_desc", "").replace("GlacierAir™", "ForgeX™")
    if ty_desc:
        html = re.sub(
    ...
    html = html.replace(
        "Il team gadgetspothub al lavoro: call center e logistica COD", shared["ty_alt"]
    )
    ...
    # IT forgex thank-you uses slightly different shipping/refund labels
...
def update_sitemap() -> None:
    ...
    for offer, cfg in GEOS.items():
        geo = cfg["geo"]
        slug = cfg["slug"]
        for loc in (f"https://gadgetspothub.com/{geo}/{slug}/", f"https://gadgetspothub.com/{geo}/{slug}/landing.html"):
            line = f'  <url><loc>{loc}</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
            if loc not in text:
                entries.append(line)
    if not entries:
        return
    marker = '  <url><loc>https://gadgetspothub.com/en/kemppi/landing.html</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
    if marker in text:
    ...
    print(f"Sitemap: added {len(entries)} ForgeX geo URLs")
